...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cc11QeIa.mjs");
...
var manifest = {
	"202c4c58366aa87a4a97ba717d9da279e4f0bcf57796e5ad232cbcd8e2618cd0": {
		functionName: "modifyMail_createServerFn_handler",
		importer: () => import("./gmail-BiC_hZzu.mjs").then((n) => n.t)
	},
	"3194eb63d1c191ac3b3aed0ebdeb0964fc3442e69d3cc672cc2d4825c9c9478f": {
		functionName: "analyzeTicker_createServerFn_handler",
		importer: () => import("./analyze-C3FQ3CcT.mjs")
	},
	"32ea09f2c4f8f9ea7db6070b7871f50a7dd7a2e41a61f9a9a164782bd92f9514": {
		functionName: "fetchQuotes_createServerFn_handler",
		importer: () => import("./market-V9v0ALEw.mjs")
	},
	"3eb257bd56dae56a0ed2512107d1a4455cb44b2d056170c539f7ba786750735b": {
		functionName: "loadMailBody_createServerFn_handler",
		importer: () => import("./gmail-BiC_hZzu.mjs").then((n) => n.t)
	},
	"889fc8aa564a03c35d876120737c23155761b0eb249dfe15ff69ac4f37920b04": {
		functionName: "loadInbox_createServerFn_handler",
		importer: () => import("./gmail-BiC_hZzu.mjs").then((n) => n.t)
	},
	"d3f278e06aa3050652eeafb59075878059fd2c3f9ed23b802f5c0cfd73cd9157": {
		functionName: "createMailDraft_createServerFn_handler",
		importer: () => import("./gmail-BiC_hZzu.mjs").then((n) => n.t)
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CRbMzPjD.mjs").then((n) => n.t),
